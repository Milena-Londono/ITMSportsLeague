...
namespace SportsLeague.Domain.Services
{
    public class MatchLineupService : IMatchLineupService
    {
        ...
        public async Task<MatchLineup> AddPlayerToLineupAsync(int matchId, MatchLineup lineup)
        {
            ...
            var alreadyExists = await _matchLineupRepository.ExistsByMatchAndPlayerAsync(
        ...
        public async Task<IEnumerable<MatchLineup>> GetMatchLineupAsync(int matchId)
        {
            ...
            _logger.LogInformation(
                "Retrieving lineup for match {MatchId}",
                matchId);
        ...
        public async Task RemovePlayerFromLineupAsync(int matchId, int lineupId)
        {
            ...
            _logger.LogInformation(
                "Removing lineup {LineupId} from match {MatchId}",
                lineupId,
                matchId);
