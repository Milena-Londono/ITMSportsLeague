...
namespace SportsLeague.Domain.Services
{
    public class StandingsService : IStandingsService
    {
        ...
        public async Task<object> GetStandingsAsync(int tournamentId)
        {
            ...
            // El ToDictionary me sirve para crear un diccionario a partir 
            // de la lista de resultados, donde la clave es el MatchId y el valor es el MatchResult.
            // Esto me permite acceder rápidamente al resultado de un partido dado su ID sin tener que recorrer toda la lista cada vez.
            var resultsByMatch = allResults.ToDictionary(r => r.MatchId); // Key - Value
            ...
            var standings = tournamentTeams.Select(tt =>
            {
                ...
                //Count me sirve para contar el número de elementos en la colección
                //que cumplen una condición específica.
                //En este caso, se cuenta cuántos partidos como local (homeMatches) 
                //resultaron en una victoria pra el equipo, es decir,
                //cuántos partidos tuvieron más goles a favor (HomeGoals) que en contra (AwayGoals).
